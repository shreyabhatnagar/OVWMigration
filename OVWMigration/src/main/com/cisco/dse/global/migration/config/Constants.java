...
public class Constants {
	...
	// TEXT_DOES_NOT_EXIST
	public static final String TEXT_DOES_NOT_EXIST = "<li>Text content doesn't exist </li>";

	// TEXT_ELEMENT_NOT_FOUND
	public static final String TEXT_ELEMENT_NOT_FOUND  = "<li>Text Element is not found on web publisher page.</li>";
	...
	// TEXT_NODE_NOT_FOUND
	public static final String TEXT_NODE_NOT_FOUND = "<li>Text node doesn't exist.</li>";

	// EXCEPTION_TEXT_COMPONENT
	public static final String EXCEPTION_TEXT_COMPONENT = "Unable to update text component ";
	...
	// SPOTLIGHT_DESCRIPTION_ELEMENT_NOT_FOUND
	...
	// SPOTLIGHT_NODE_NOT_FOUND
	public static final String SPOTLIGHT_NODE_NOT_FOUND = "<li>Spotlight Component node not found</li>";

	// SPOTLIGHT_PARENT_NODE_NOT_FOUND
	public static final String SPOTLIGHT_PARENT_NODE_NOT_FOUND = "<li>Unable to update spotlight component as it's respective node is not found.</li>";

	// SPOTLIGHT_PARENT_DIV_NOT_FOUND
	...
	//PAGE_IS_NOT_MIGRATED_HTML_STRUCTURE_IS_DIFFERENT
	public static final String PAGE_IS_NOT_MIGRATED_HTML_STRUCTURE_IS_DIFFERENT = "<li>Page is not migratd, html structure is different.</li>";
	...
	//LEFT_GRID_HEADING_NOT_FOUND
	public static final String LEFT_GRID_HEADING_NOT_FOUND = "<li>Left grid heading not found.</li>";

	//LEFT_GRID_PARAGRAPH_NOT_FOUND
	public static final String LEFT_GRID_PARAGRAPH_NOT_FOUND = "<li>Left grid paragraph not found.</li>";
	...
	//UNABLE_TO_UPDATE_PRODUCTLISTING
	...
	//LIST_PARAGRAPH_ELEMENT_NOT_FOUND
	public static final String LIST_PARAGRAPH_ELEMENT_NOT_FOUND = "<li>List Paragraph element not found.</li>";

	//LIST_INTRO_NODE_NOT_FOUND
	public static final String LIST_INTRO_NODE_NOT_FOUND = "<li>List Intro node not found</li>";

	//LIST_ELEMENT_LIST_NODE_NOT_FOUND
	...
	//LIST_INTRO_PARAGRAPH_ELEMENT_NOT_FOUND
	public static final String LIST_INTRO_PARAGRAPH_ELEMENT_NOT_FOUND = "<li>Intro paragraph element of list component not found</li>";

	//LIST_ELEMENT_NOT_FOUND
	public static final String LIST_ELEMENT_NOT_FOUND = "<li>List elements not found</li>";

	//MIS_MATCH_OF_TILE_BORDERED_COMPONENTS
	public static final String MIS_MATCH_OF_TILE_BORDERED_COMPONENTS = "<li>Could not migrate  tilebordered node. Count mis match</li>";
	...
	//TILE_BORDERED_NODES_NOT_FOUND
	public static final String TILE_BORDERED_NODES_NOT_FOUND = "<li>Tile bordered nodes are not found.</li>";

	//TILE_BORDERED_ELEMENTS_NOT_FOUND
	public static final String TILE_BORDERED_ELEMENTS_NOT_FOUND = "<li>Tile bordered elements are not found.</li>";
	...
	//LIST_HEADING_COMPONENT_NOT_FOUND
	public static final String LIST_HEADING_COMPONENT_NOT_FOUND = "<li>List heading Component not found on locale page.</li>";
	...
	public static final String MISMATCH_IN_TILEBORDER_COUNT = "<li>Mismatch of tile border count. Locale page has ";

	//TILEBORDER_NODE_COUNT	
	public static final String TILEBORDER_NODE_COUNT = " and tile node count is ";

	//TILEBORDER_NODE_COUNT	
	public static final String TILEBORDER_COMPONENT_NOT_FOUND = "<li>Tile Border Component not found on local page.</li>";
