 ...
 * 1		kiran	5-jan-16	Added the Java file to handle the migration of responsive service listing pages.
 * 
 * */
...
public class RServiceListingVariation2 extends BaseAction{
	Document doc;
	StringBuilder sb = new StringBuilder(1024);
	static Logger log = Logger.getLogger(RServiceListingVariation2.class);
		...
		try {
			...
			if (doc != null) {
				...
				try {
					...
					if (serviceListingNode
							.hasNode("thirds/Th-Third-3/text")) {
						rightListContainerNode = serviceListingNode
								.getNode("thirds/Th-Third-3/text");
					}
							...
							if (count == 1) {
								...
								if (listContainerNode != null) {
									...
									/*	if (listNode.hasNode("text")) {
										...
										if (listItemsNode != null) {
											String textEle = doc.select("div.c00-pilot").last().html();
											listItemsNode.setProperty(
													"text",textEle );
