	...
	public String translate(String loc, String prod, String type,
		...
		try {
			...
			try {
				...
				sb.append("<li>Unable to update benefits text component." + e
						+ "</li>");
			}
			...
			try {
				...
				if (layoutOverViewNode != null) {
					if (layoutOverViewNode.hasNode("gd14v1")) {
						...
						if (gd14v1.hasNode("gd14v1-left")) {
							Node gd14v1_left = gd14v1.getNode("gd14v1-left");
							...
							if (textNodeIterator.getSize() == gd14v1_lefts
								...
								for (Element ele : gd14v1_lefts) {
									...
									Node textNode = (Node) textNodeIterator
											.next();
									textNode.setProperty("text", leftGridHtml);
								}
							} else {
						...
						if (gd14v1.hasNode("gd14v1-mid-right")) {
							...
							if (textNodeIterator.getSize() == gd14v1_mid_rights
								...
								for (Element ele : gd14v1_mid_rights) {
									String midRightGridHtml = ele.html();
									textNodeIterator.hasNext();
									Node textNode = (Node) textNodeIterator
											.next();
									textNode.setProperty("text",
						...
						if (gd14v1.hasNode("gd14v1-right")) {
							Node gd14v1_right = gd14v1.getNode("gd14v1-right");
							...
							if (textNodeIterator.getSize() == gd14v1_rights
								...
								for (Element ele : gd14v1_rights) {
									...
									Node textNode = (Node) textNodeIterator
											.next();
									textNode.setProperty("text", rightGridHtml);
								}
							} else {
								sb.append("<li>Number of nodes("
										+ textNodeIterator.getSize()
				...
				if (grids1 != null) {
					...
					if (grid != null) {
						...
						if (leftGridElements != null) {
							Element leftGridElement = leftGridElements.first();
						...
						if (midGridElements != null) {
							Element midGridElement = midGridElements.first();
				...
				if (layoutOverViewNode != null) {
					if (layoutOverViewNode.hasNode("gd13v2")) {
						Node gd13v2 = layoutOverViewNode.getNode("gd13v2");
						if (gd13v2 != null) {
							Node gd13v2_left = gd13v2.getNode("gd13v2-left");
							if (gd13v2_left != null) {
								...
								if (textNodes.getSize() == c100_pilot_left
									...
									for (Element ele : c100_pilot_left) {
										String leftGridHTML = ele.html();
										textNodes.hasNext();
										Node textNode = (Node) textNodes.next();
										textNode.setProperty("text",
												leftGridHTML);
									}
								} else {
							...
							Node gd13v2_mid = gd13v2.getNode("gd13v2-mid");
							if (gd13v2_mid != null) {
							...
							Node gd13v2_right = gd13v2.getNode("gd13v2-right");
